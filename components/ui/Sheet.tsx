...
const SheetContent = ({
  ...
  return (
    <SheetPortal>
      ...
      >
        {children}
        <SheetPrimitive.Close className="top-4 right-4 absolute data-[state=open]:bg-secondary opacity-70 hover:opacity-100 focus-visible:opacity-100 rounded-xs focus:outline-hidden focus:ring-2 focus:ring-ring ring-offset-background focus:ring-offset-2 transition-opacity disabled:pointer-events-none">
